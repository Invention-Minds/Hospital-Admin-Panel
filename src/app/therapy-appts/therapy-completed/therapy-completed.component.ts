...
@Component({
  selector: 'app-therapy-completed',
  templateUrl: './therapy-completed.component.html',
  styleUrl: './therapy-completed.component.css'
})
export class TherapyCompletedComponent {
  ...
  fetchConfirmedAppointments(): void {
    ...
    this.therapyService.getCompletedAppointments().subscribe({
      next: (services: any[]) => {
