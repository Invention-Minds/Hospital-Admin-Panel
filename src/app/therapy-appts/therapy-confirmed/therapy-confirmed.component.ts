...
@Component({
  selector: 'app-therapy-confirmed',
  templateUrl: './therapy-confirmed.component.html',
  styleUrl: './therapy-confirmed.component.css'
})
export class TherapyConfirmedComponent {
  ...
  fetchConfirmedAppointments(): void {
    ...
    this.therapyService.getConfirmedAppointments().subscribe({
      next: (services: any[]) => {
