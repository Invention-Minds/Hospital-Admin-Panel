...
@Component({
  selector: 'app-confirm-mhc',
  templateUrl: './confirm-mhc.component.html',
  styleUrl: './confirm-mhc.component.css'
})
export class ConfirmMhcComponent {
  ...
  filterAppointmentsByDate(selectedDate: Date) {
    const formattedSelectedDate = this.formatDate(selectedDate);
      ...
      // ✅ If no MHC filter, apply only date filtering
