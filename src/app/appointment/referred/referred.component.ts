...
@Component({
  ...
  styleUrl: './referred.component.css'
})
...
export class ReferredComponent {
  ...
  openAppointmentForm(service: any): void {
    console.log(service.patientName)
    ...
    const nameParts = service.patientName.split(' ');
    this.selectedAppointment.patientName = service.patientName
    this.selectedAppointment.phoneNumber = service.phoneNumber.startsWith('91') ? service.phoneNumber : '91' + service.phoneNumber;
    this.selectedAppointment.email = service.email;
    this.selectedAppointment.requestVia = 'Walk-In';
    this.selectedAppointment.status = service.status;
    this.selectedAppointment.prnNumber = service.prnNumber;
    this.selectedAppointment.emailSent = true;
    this.selectedAppointment.smsSent = true;
    this.selectedAppointment.messageSent = true;
    this.selectedAppointment.age = service.age;
    this.selectedAppointment.gender = service.gender;
  ...
  submitAppointment(appointment: any | null, status: string, requestVia: any) {
