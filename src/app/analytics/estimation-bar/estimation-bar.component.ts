...
import { getIndividualDates, getYesterdayDate } from '../functions'
...
export class EstimationBarComponent implements OnChanges {
  ...
  constructor(private estimation: EstimationService, private datePipe: DatePipe) { }
  ...
  mapStatusesToDates() {
    ...
    const today = new Date(this.selectedDate[0]);
