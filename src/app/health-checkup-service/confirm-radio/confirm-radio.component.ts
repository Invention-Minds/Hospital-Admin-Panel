...
@Component({
  selector: 'app-confirm-radio',
  templateUrl: './confirm-radio.component.html',
  styleUrl: './confirm-radio.component.css'
})


export class ConfirmRadioComponent {
