...
@Component({
  selector: 'app-service-cancel',
  templateUrl: './service-cancel.component.html',
  styleUrl: './service-cancel.component.css'
})

export class ServiceCancelComponent {

  constructor(private healthCheckupService: RadiologyService, private messageService: MessageService){}
