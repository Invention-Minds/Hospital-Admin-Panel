...
@Component({
  selector: 'app-estimation-request',
  templateUrl: './estimation-request.component.html',
  styleUrl: './estimation-request.component.css',
    ...
    onSearch(): void {
      ...
      this.filteredEstimations = this.pendingEstimations.filter((service) => {
        ...
        if (this.selectedDateRange && this.selectedDateRange.length) {
          ...
          matches = matches && (inRange(service.estimationPreferredDate) || inRange(service.estimationCreatedTime));
        }
